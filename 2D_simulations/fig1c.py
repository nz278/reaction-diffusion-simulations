...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Replicate Fig 1C (JAPI/PAPI, ON/Turing/Irregular/OFF)")
    parser.add_argument("--nx", type=int, default=100)
    parser.add_argument("--ny", type=int, default=100)
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--max-steps", type=int, default=50000)
    parser.add_argument("--out", type=str, default="fig1c.png")
    args = parser.parse_args()

    make_figure(args.nx, args.ny, args.seed, args.max_steps, args.out)
